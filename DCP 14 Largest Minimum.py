...
# Solution
# =====================================================================================================================
def minimum_range(homes, towers):
    """
    minimum_range: determines the minimum broadcast range would have to be in order for each home to be covered
    :param homes: (list(ints)) List of ints representing where a home is
    :param towers: (list(ints)) List of ints representing where a radio tower is
    :return: The largest distance required for the radio wave to travel
    """
    largest_minimum = 0
    for home in homes:
        current = None
        for tower in towers:
            ...
            if current is None:
                ...
                current = temp
        if current > largest_minimum:
            largest_minimum = current
...
# Input
# =====================================================================================================================
minimum_range([1, 5, 11, 20], [4, 8, 15])
